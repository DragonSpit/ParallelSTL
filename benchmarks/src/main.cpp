// TODO: Install VS2022 on the AWS 48-core node
// TODO: Install OneAPI Base on the AWS 48-core node
// TODO: Add my sort algorithms to this project to see how much faster they are in this environment, most likely due to the higher performance memory allocator
...
void fill_benchmark(size_t array_size, int num_times)
{
...
void sort_benchmark(size_t array_size, int num_times)
{
...
void stable_sort_benchmark(size_t array_size, int num_times)
{
...
void merge_benchmark(size_t array_size, int num_times)
{
    ...
    sort(std::execution::seq, data_int_src_0.begin(), data_int_src_0.end());
    sort(std::execution::seq, data_int_src_1.begin(), data_int_src_1.end());
...
void inplace_merge_benchmark(size_t array_size, int num_times)
{
    ...
    for (size_t i = 0; i < num_times; i++)
    {
        ...
        sort(std::execution::seq, data_int.begin(), data_int.begin() + data_int.size() / 2);  // left  half
        sort(std::execution::seq, data_int.begin() + data_int.size() / 2, data_int.end());    // right half
...
void merge_dual_buffer_benchmark(size_t array_size, int num_times)
{
    ...
    sort(std::execution::seq, data_int_src.begin(), data_int_src.begin() + array_size);
    sort(std::execution::seq, data_int_src.begin() + array_size, data_int_src.begin() + 2 * array_size);
    sort(std::execution::seq, data_int_dst.begin(), data_int_dst.begin() + 2 * array_size);
...
void merge_single_buffer_benchmark(size_t array_size, int num_times)
{
    ...
    sort(std::execution::seq, data_int_src_dst.begin(), data_int_src_dst.begin() + array_size);
    sort(std::execution::seq, data_int_src_dst.begin() + array_size, data_int_src_dst.begin() + 2 * array_size);
    sort(std::execution::seq, data_int_src_dst.begin() + 2 * array_size, data_int_src_dst.end());
...
void all_of_benchmark(size_t array_size, int num_times)
{
    std::vector<int> data_int(array_size, 2);
    high_resolution_clock::time_point startTime, endTime;
...
void any_of_benchmark(size_t array_size, int num_times)
{
    std::vector<int> data_int(array_size, 2);
    high_resolution_clock::time_point startTime, endTime;
...
void copy_benchmark(size_t array_size, int num_times)
{
...
void equal_benchmark(size_t array_size, int num_times)
{
